...
const AddProduct = () => {
  const handleAddProduct = (e) => {
    ...
    const imgURL = form.img_url.value;
    ...
    const newProduct = { brand, product, imgURL, description, price, rating };
    toast("THANKS for your contribute!")
    form.reset()
  };

  return (
    <div className="my-10 px-2 dark:text-gray-300">
      <h1 className="text-4xl text-center mb-3 ">Add your desire product</h1>
      <form onSubmit={handleAddProduct}>
        <div className="border-2 border-teal-500 rounded-md p-8 w-full md:w-[70%] mx-auto flex flex-col items-center md:items-stretch gap-y-4 ">
          ...
          <button
            type="submit"
            className="border-2 font-semibold border-teal-500 p-2 bg-teal-100 hover:bg-teal-500 rounded-md dark:bg-slate-600 dark:hover:bg-teal-500 "
          >
            Add Product
          </button>
        </div>
